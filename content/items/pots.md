...
No effect on other item categories, so it can be used as storage for riceballs,<br/>Strength Grass, Mixer synthesis items, scrolls, etc.<br/>
Found in sizes 3~6.
...
Protects riceballs from spoiling, and also prevents scrolls from getting wet.<br/>
...
Transforms inserted items into other items.<br/>
...
<ul>
  ...
  <li>Turn riceballs into spoiled riceballs.</li>
  <li>Put out fires.</li>
  <li>Halves attack of monsters wielding weapons. (can stack)
    <ul>
      <li>Ashigarudon, Yamikichi, Shaaga, Gale, Kengo, Taurus families, Galaha.</li>
    </ul>
  </li>
